...
#Reading the test file having the data of footballers and target being their overall skill score ( 1-100 ).

import pandas as pd

player_df = pd.read_csv("datascientist/feature_selection/test/data.csv")

#Taking only those columns which have numerical or categorical values since feature selection with Pearson Correlation can be performed on numerical data.
