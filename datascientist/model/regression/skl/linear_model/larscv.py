...
def _larscv(*, train, test, x_predict=None, metrics, fit_intercept=True, verbose=False,
    ...
    model = LarsCV(fit_intercept=fit_intercept, verbose=verbose, max_iter=max_iter,
        normalize=normalize, precompute=precompute, cv=cv, max_n_alphas=max_n_alphas,
        n_jobs=n_jobs, eps=eps, copy_X=copy_X)
